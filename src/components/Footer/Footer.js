...
import logo from "../../assets/icon/logoE.svg";
      ...
      <div className={classes.footerContainer}>
        <Grid container className={classes.footer}>
          <Grid item lg={4} md={4} sm={6} xs={12}>
            ...
            <Typography>
              تورینو بزرگترین و معتبرترین سایت خرید اینترنتی بلیط هواپیما ،
              قطار و اتوبوس در کشور است که از سال 1393 کار خود را شروع کرده و در
              این مدت توانسته رضایت درصد قابل توجهی از کاربران را به دست بیاورد.
              در ابتدا، فروش بلیط پرواز داخلی در دستور کار گردشگری قرار داشت؛
              اما به مرور امکان خرید سایر محصولات گردشگری نیز به گردشگری اضافه
              شد.
            </Typography>
          </Grid>
          <Grid item lg={2} md={2} sm={6} xs={12}>
            ...
            <ul>
              ...
              <li>
                <Link href="#">انتقادات و پیشنهادات</Link>
              </li>
              <li>
            ...
            <Grid container>
              ...
              <Grid item lg={4} md={4} sm={4} xs={4}>
                <img
                  ...
                  onClick={() => {
                    window.open(
                      "https://logo.samandehi.ir/Verify.aspx?id=271503&p=uiwkjyoerfthdshwobpdxlao",
                      "Popup",
        ...
        <div className={classes.copyright}>
          <div>
            <Typography>
              کلیه حقوق این سایت محفوظ و متعلق به آژانس هواپیمایی و جهانگردی
              تورینو می‌باشد
            </Typography>
          </div>
          <div>
