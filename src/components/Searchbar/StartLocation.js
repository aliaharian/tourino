...
const StartLocation = (props) => {
    ...
    return (<>
        <div className={clsx(classes.searchbarItem, classes.noAfter, props.selected && classes.searchbarItemActive)}
            ref={anchorEl}
            ...
            <Typography noWrap> {props.startLocation?.name || 'کجا هستید؟'} </Typography>
        </div>
                                    ...
                                    {recent &&
                                        <div className={classes.locationHistoryContainer}>
                                            ...
                                            {recent && recent.map((item) => (
                                                <div className={classes.locationHistoryItem} onClick={() => {
                                        ...
                                        <div className={classes.locationOfferItemContainer}>
                                            ...
                                            {cities && cities.map((city) => (
                                                <div onClick={() => {
                                                    ...
                                                    className={clsx(classes.locationOfferItem, props.startLocation?.id === city.id && classes.selectedCity)}>
