...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _SingleDatePickerShape = __webpack_require__(58);
	...
	var _toMomentObject = __webpack_require__(42);

	var _toMomentObject2 = _interopRequireDefault(_toMomentObject);

	var _toLocalizedDateString = __webpack_require__(43);
	...
	var moment_day = _moment2['default'].locale() == 'fa' ? (0, _momentJalaliDate2['default'])() : (0, _moment2['default'])();
	var defaultProps = {
	    ...
	    isOutsideRange: function () {
	        function isOutsideRange(day) {
	            return !(0, _isInclusivelyAfterDay2['default'])(day, moment_day);
	        }
	    ...
	    _createClass(SingleDatePicker, [{
	        ...
	        value: function () {
	            function componentWillReceiveProps(nextProps) {
	                ...
	                if (didFocusChange) {
	                    (0, _object2['default'])(visibleDays).forEach(function (days) {
	                        Object.keys(days).forEach(function (day) {
	                            ...
	                            var momentObj = _moment2['default'].locale() == 'fa' ? (0, _momentJalaliDate2['default'])() : (0, _moment2['default'])();
	                ...
	                if (Object.keys(modifiers).length > 0) {
	                    var _currentMonth = this.state.currentMonth;

	                    var MonthVisibleDays = (0, _getVisibleDays2['default'])(_currentMonth, 1, enableOutsideDays);
	                    this.setState({
	                        visibleDays: (0, _object4['default'])({}, visibleDays, this.getModifiers(MonthVisibleDays))
	                    });
	                }
	            }
	        ...
	        value: function () {
	            function componentWillUpdate() {
	                this.today = _moment2['default'].locale() == 'fa' ? (0, _momentJalaliDate2['default'])() : (0, _moment2['default'])();
	            }
	        ...
	        value: function () {
	            function onPrevMonthClick() {
	                ...
	                var prevMonth = currentMonth.clone().subtract(1, format);
	        ...
	        value: function () {
	            function onNextMonthClick() {
	                ...
	                var nextMonth = currentMonth.clone().add(numberOfMonths, format);
	        ...
	        value: function () {
	            function getFirstFocusableDay(newMonth) {
	                ...
	                var format = _moment2['default'].locale() == 'fa' ? 'jMonth' : 'month';
	                var focusedDate = newMonth.clone().startOf(format);
	                if (date) {
	                ...
	                if (this.isBlocked(focusedDate)) {
	                    var days = [];
	                    var lastVisibleDay = newMonth.clone().add(numberOfMonths - 1, _moment2['default'].locale() == 'fa' ? 'jMonths' : 'months').endOf(format);
	        ...
	        value: function () {
	            function addModifier(updatedDays, day, modifier) {
	                ...
	                if (enableOutsideDays) {
	                    var startOfMonth = day.clone().startOf(format);
	                    var endOfMonth = day.clone().endOf(format);
	                    if ((0, _isBeforeDay2['default'])(startOfMonth, currentMonth.clone().startOf(format)) || (0, _isAfterDay2['default'])(endOfMonth, currentMonth.clone().endOf(format))) {
	        ...
	        value: function () {
	            function clearDate() {
	                var _props11 = this.props,
	                    onDateChange = _props11.onDateChange,
	                    reopenPickerOnClearDate = _props11.reopenPickerOnClearDate,
	                    onFocusChange = _props11.onFocusChange;
	        ...
	        value: function () {
	            function responsivizePickerPosition() {
	                var _props12 = this.props,
	                    anchorDirection = _props12.anchorDirection,
	                    horizontalMargin = _props12.horizontalMargin,
	        ...
	        value: function () {
	            function isBlocked(day) {
	                var _props13 = this.props,
	                    isDayBlocked = _props13.isDayBlocked,
	        ...
	        value: function () {
	            function renderDayPicker() {
	                ...
	                var _props15 = this.props,
	                    enableOutsideDays = _props15.enableOutsideDays,
	                    numberOfMonths = _props15.numberOfMonths,
	                    orientation = _props15.orientation,
	                    monthFormat = _props15.monthFormat,
	                    navPrev = _props15.navPrev,
	                    navNext = _props15.navNext,
	                    withPortal = _props15.withPortal,
	                    withFullScreenPortal = _props15.withFullScreenPortal,
	                    focused = _props15.focused,
	                    renderMonth = _props15.renderMonth,
	                    renderDay = _props15.renderDay,
	                    renderCalendarInfo = _props15.renderCalendarInfo,
	                    hideKeyboardShortcutsPanel = _props15.hideKeyboardShortcutsPanel,
	                    customCloseIcon = _props15.customCloseIcon,
	                    phrases = _props15.phrases,
	                    daySize = _props15.daySize,
	                    isRTL = _props15.isRTL;
	                var _state7 = this.state,
	                    dayPickerContainerStyles = _state7.dayPickerContainerStyles,
	                    isDayPickerFocused = _state7.isDayPickerFocused,
	        ...
	        value: function () {
	            function render() {
	                var _props16 = this.props,
	                    id = _props16.id,
	                    placeholder = _props16.placeholder,
	                    disabled = _props16.disabled,
	                    focused = _props16.focused,
	                    required = _props16.required,
	                    showClearDate = _props16.showClearDate,
	                    date = _props16.date,
	                    phrases = _props16.phrases,
	                    withPortal = _props16.withPortal,
	                    withFullScreenPortal = _props16.withFullScreenPortal,
	                    screenReaderInputMessage = _props16.screenReaderInputMessage,
