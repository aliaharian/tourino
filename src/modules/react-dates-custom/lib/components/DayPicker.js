...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _CalendarMonthGrid = __webpack_require__(45);

	var _CalendarMonthGrid2 = _interopRequireDefault(_CalendarMonthGrid);

	var _DayPickerNavigation = __webpack_require__(46);

	var _DayPickerNavigation2 = _interopRequireDefault(_DayPickerNavigation);

	var _DayPickerKeyboardShortcuts = __webpack_require__(47);
	...
	var _getActiveElement = __webpack_require__(48);
	...
	var defaultProps = exports.defaultProps = {
	    ...
	    initialVisibleMonth: function () {
	        function initialVisibleMonth() {
	            return _moment2['default'].locale() == 'fa' ? (0, _momentJalaliDate2['default'])() : (0, _moment2['default'])();
	        }
	...
	var DayPicker = function (_React$Component) {
	    ...
	    function DayPicker(props) {
	        ...
	        if (_moment2['default'].locale() == 'fa') {
	            currentMonth = props.hidden ? (0, _momentJalaliDate2['default'])() : props.initialVisibleMonth();
	            format = 'jMonth';
	        } else {
	        ...
	        var focusedDate = currentMonth.clone().startOf(format);
	    ...
	    _createClass(DayPicker, [{
	        ...
	        value: function () {
	            function onKeyDown(e) {
	                var format_w = _moment2['default'].locale() == 'fa' ? 'week' : 'week';
	                var format_m = _moment2['default'].locale() == 'fa' ? 'month' : 'month';
	                var format_d = _moment2['default'].locale() == 'fa' ? 'day' : 'day';
	                ...
	                switch (e.key) {
	                    case 'ArrowUp':
	                        e.preventDefault();
	                        newFocusedDate.subtract(1, format_w);
	                        didTransitionMonth = this.maybeTransitionPrevMonth(newFocusedDate);
	                        break;
	                    case 'ArrowLeft':
	                        e.preventDefault();
	                        newFocusedDate.subtract(1, format_d);
	                        didTransitionMonth = this.maybeTransitionPrevMonth(newFocusedDate);
	                        break;
	                    case 'Home':
	                        e.preventDefault();
	                        newFocusedDate.startOf(format_w);
	                        didTransitionMonth = this.maybeTransitionPrevMonth(newFocusedDate);
	                        break;
	                    case 'PageUp':
	                        e.preventDefault();
	                        newFocusedDate.subtract(1, format_m);
	                        didTransitionMonth = this.maybeTransitionPrevMonth(newFocusedDate);
	                        break;

	                    case 'ArrowDown':
	                        e.preventDefault();
	                        newFocusedDate.add(1, format_w);
	                        didTransitionMonth = this.maybeTransitionNextMonth(newFocusedDate);
	                        break;
	                    case 'ArrowRight':
	                        e.preventDefault();
	                        newFocusedDate.add(1, format_d);
	                        didTransitionMonth = this.maybeTransitionNextMonth(newFocusedDate);
	                        break;
	                    case 'End':
	                        e.preventDefault();
	                        newFocusedDate.endOf(format_w);
	                        didTransitionMonth = this.maybeTransitionNextMonth(newFocusedDate);
	                        break;
	                    case 'PageDown':
	                        e.preventDefault();
	                        newFocusedDate.add(1, format_m);
	                        didTransitionMonth = this.maybeTransitionNextMonth(newFocusedDate);
	                        break;
