...
/***/ (function(module, exports, __webpack_require__) {
	...
	var defaultProps = {
	  ...
	  initialMonth: _moment2['default'].locale() == 'fa' ? (0, _momentJalaliDate2['default'])() : (0, _moment2['default'])(),
	  isAnimating: false,
	  numberOfMonths: 1,
	  modifiers: {},
	...
	function getMonths(initialMonth, numberOfMonths) {
	  ...
	  var month = initialMonth.clone().subtract(1, format);
	  ...
	  _createClass(CalendarMonthGrid, [{
	    ...
	    value: function () {
	      function componentWillReceiveProps(nextProps) {
	        ...
	        var format = _moment2['default'].locale() == 'fa' ? 'jMonth' : 'month';
	        var hasMonthChanged = !this.props.initialMonth.isSame(initialMonth, format);
