...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _getPhrase = __webpack_require__(11);
	...
	var defaultProps = {
	    day: _moment2['default'].locale() == 'fa' ? (0, _momentJalaliDate2['default'])() : (0, _moment2['default'])(),
	        ...
	        value: function () {
	            function render() {
	                ...
	                return _react2['default'].createElement('td', { className: className, style: daySizeStyles }, _react2['default'].createElement('button', {
	                    ...
	                    tabIndex: tabIndex
	                }, renderDay ? renderDay(day) : _moment2['default'].locale() == 'fa' ? day.format('jD') : day.format('D')));
	            }
