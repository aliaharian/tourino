...
export default function DayPickerNavigation(props) {
  ...
  if (!navPrevIcon) {
    ...
    navPrevIcon = isVertical ? <ChevronUp /> : <KeyboardArrowLeftIcon />;
    if (isRTL && !isVertical) {
      navPrevIcon = <KeyboardArrowRightIcon />;
    }
  }
  if (!navNextIcon) {
    isDefaultNavNext = true;
    navNextIcon = isVertical ? <ChevronDown /> : <KeyboardArrowRightIcon />;
    if (isRTL && !isVertical) {
      navNextIcon = <KeyboardArrowLeftIcon />;
    }
  }
